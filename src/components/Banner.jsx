    ...
    <div className="container mx-auto">
      <div className="flex py-20 items-center justify-between">
        <div className="right space-y-4">
          <div className="inline-flex gap-1.5 bg-blue-100 p-1 rounded-full items-center mb-3.5">
            <span className="loading bg-blue-500 loading-ring loading-xs"></span>
            <p className="bg-gradient-to-r from-purple-800 to-blue-500 bg-clip-text text-[20px] text-transparent">
